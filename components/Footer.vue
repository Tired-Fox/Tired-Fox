...
<template>
  <footer class="flex justify-evenly my-3 flex-col md:flex-row w-[90%] mx-auto">
    ...
    <p>&copy; {{getCopyrightDates()}} Zachary Boehm. All Rights Reserved.</p>
    <div></div>
  </footer>
</template>